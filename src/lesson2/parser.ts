...
const setEndPosition = (position: number, brackets: BracketsPositions): BracketsPositions => {
...
export const populateBracketsPositions = (item: string, position: number, brackets: BracketsPositions): BracketsPositions => {
...
export const parser = (line: string): [ParsedLineType, BracketsPositions] | null => {
